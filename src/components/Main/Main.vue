            ...
            <form role="form">
              ...
              <div class="row gy-3">
                ...
                <div class="form-group">
                  ...
                  <select
                    v-model="resourceToDownload"
                    class="form-select"
                    name="resourceToDownload"
                    id="resourceToDownload"
                  >
                    <option disabled hidden value="">
                      Выберите источник профстандартов...
                    </option>
                    <option
                  ...
                  <p
                    class="help-block"
                    v-if="resourceToDownload === 'Росминтруд'"
                  >
                    <i style="color: lightgray"
                      ><b>([https://profstandart.rosmintrud.ru/])</b></i
                    >
                  </p>
                </div>
...
export default {
  ...
  data() {
    return {
      ...
      // Переменные форм подбора профстандарта
      resourceOptions: [{ id: 0, name: "Росминтруд" }],
      educationLevels: [
        { id: 0, name: "Бакалавриат" },
